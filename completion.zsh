...
## Completions - Environmental variables.

zstyle ':completion::*:(-command-|export):*' fake-parameters ${${${_comps[(I)-value-*]#*,}%%,*}:#-*-}

## Completions - Hostnames.
...
### Ignore multiple entries for these completions.
